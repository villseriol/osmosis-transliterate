...
public class LetterlikeMapper implements Unimap {
    ...
    static {
        ...
        rules.add("ℇ > '¿';"); // 2107 EULER CONSTANT
        ...
        rules.add("℥ > '¿';"); // 2125 OUNCE SIGN
        rules.add("Ω > '¿';"); // 2126 OHM SIGN
        rules.add("℧ > '¿';"); // 2127 INVERTED OHM SIGN
        rules.add("ℨ > 'Z';"); // 2128 BLACK-LETTER CAPITAL Z (dup)
        rules.add("℩ > '¿';"); // 2129 TURNED GREEK SMALL LETTER IOTA
        ...
        rules.add("Ⅎ > '¿';"); // 2132 TURNED CAPITAL F
        ...
        rules.add("℺ > '¿';"); // 213A ROTATED CAPITAL Q
        ...
        rules.add("⅀ > '¿';"); // 2140 DOUBLE-STRUCK N-ARY SUMMATION
        rules.add("⅁ > '¿';"); // 2141 TURNED SANS-SERIF CAPITAL G
        rules.add("⅂ > '¿';"); // 2142 TURNED SANS-SERIF CAPITAL L
        rules.add("⅃ > '¿';"); // 2143 REVERSED SANS-SERIF CAPITAL L
        rules.add("⅄ > '¿';"); // 2144 TURNED SANS-SERIF CAPITAL Y
        ...
        rules.add("⅏ > '¿';"); // 214F SYMBOL FOR SAMARITAN SOURCE
