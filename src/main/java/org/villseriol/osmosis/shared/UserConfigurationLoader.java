...
public final class UserConfigurationLoader<T> {
    private final Class<T> configurationType;

    private UserConfigurationLoader(Class<T> configurationType) {
        this.configurationType = configurationType;
    }


    public static <T> UserConfigurationLoader<T> getInstance(Class<T> configurationType) {
        return new UserConfigurationLoader<>(configurationType);
    }
